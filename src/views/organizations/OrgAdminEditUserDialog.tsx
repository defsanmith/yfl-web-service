...
import { updateUserAction } from "@/app/(protected)/(org-admin)/users/actions";
...
type OrgAdminEditUserDialogProps = {
  user: User;
  open: boolean;
  onOpenChange: (open: boolean) => void;
};

export default function OrgAdminEditUserDialog({
  user,
  open,
  onOpenChange,
}: OrgAdminEditUserDialogProps) {
