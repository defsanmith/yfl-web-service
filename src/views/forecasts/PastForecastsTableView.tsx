...
type PastForecastsTableViewProps = {
...
export default function PastForecastsTableView({
  forecasts,
  pagination,
}: PastForecastsTableViewProps) {
  ...
  const handlePageChange = (page: number) => {
    ...
    router.push(`${Router.USER_FORECASTS_PAST}?${params.toString()}`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-3xl font-bold">Past Forecasts</h1>
      </div>
