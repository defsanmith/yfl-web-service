...
import { createUserAction } from "@/app/(protected)/(org-admin)/users/actions";
...
type OrgAdminCreateUserDialogProps = {
  organizationId: string;
  open: boolean;
  onOpenChange: (open: boolean) => void;
};

export default function OrgAdminCreateUserDialog({
  organizationId,
  open,
  onOpenChange,
}: OrgAdminCreateUserDialogProps) {
